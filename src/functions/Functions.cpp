...
namespace MI { namespace function {
  ...
  MI::Function print = {
    1,
    new uint16_t[1]{
      1 | (VariableRef::VOID << 1)					/* arg[0+]: any type */
    },
    exec_print};
  MI::Function system = {
    1,
    new uint16_t[1]{
      1 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4)	/* arg[0+]: type 'string' or 'list' */
    },
    exec_system};
  MI::Function search = {
    4,
    new uint16_t[4]{
      0 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4), 	/* arg[0]: type 'string' or 'list' */
      0 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4), 	/* arg[1]: type 'string' or 'list' */
      0 | (VariableRef::BOOLEAN << 1), 				/* arg[2]: type 'boolean' */
      0 | (VariableRef::LIST << 1) 				/* arg[3]: type 'list' */
    },
    exec_search};
  ...
  MI::Function project = {
    3,
    new uint16_t[3]{
      0 | (VariableRef::STRING << 1), 				/* arg[0]: type 'string' */
      0 | (VariableRef::STRING << 1),				/* arg[1]: type 'string' */
      0 | (VariableRef::STRING << 1)				/* arg[2]: type 'string' */
    },
    exec_project
  };
  MI::Function library = {
  ...
  MI::Function source = {
    1,
    new uint16_t[1]{
      1 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4), 	/* arg[0+1]: type 'string' or 'list' */
    },
    exec_source
  };
  MI::Function makefile = {
    ...
    new uint16_t[6]{
      ...
      0 | (VariableRef::STRING << 1),			 		/* arg[1]: type 'string' */
      0 | (VariableRef::STRING << 1),			 		/* arg[2]: type 'string' */
      0 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4), 	/* arg[3]: type 'string' or 'list' */
      0 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4), 	/* arg[4]: type 'string' or 'list' */
      0 | (VariableRef::STRING << 1) | (VariableRef::LIST << 4) 	/* arg[5]: type 'string' or 'list' */
    },
    exec_makefile
  };
  MI::Function ycm = {
